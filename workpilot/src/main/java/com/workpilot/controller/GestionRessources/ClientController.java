...
public class ClientController {
    ...
    public ResponseEntity<?> createClient(@Valid @RequestBody ClientDTO clientDTO) {
        try {
            ...
            // ✅ Convertir en DTO pour éviter les boucles infinies
            ClientDTO responseDTO = new ClientDTO();
            responseDTO.setId(savedClient.getId());
            responseDTO.setCompany(savedClient.getCompany());
            responseDTO.setSalesManagers(savedClient.getSalesManagers());
            responseDTO.setContact(savedClient.getContact());
            responseDTO.setAddress(savedClient.getAddress());
            responseDTO.setEmail(savedClient.getEmail());
            responseDTO.setProjects(new ArrayList<>()); // Pas de projets pour éviter les boucles
    ...
    public ResponseEntity<?> updateClient(@PathVariable Long id, @Valid @RequestBody ClientDTO clientDTO) {
        try {
            ...
            responseDTO.setCompany(updatedClient.getCompany());
            responseDTO.setSalesManagers(updatedClient.getSalesManagers());
            responseDTO.setContact(updatedClient.getContact());
            responseDTO.setAddress(updatedClient.getAddress());
