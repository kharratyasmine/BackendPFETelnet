...
public class WeeklyReportServiceImpl implements WeeklyReportService  {
    ...
    @Override
    public List<WeeklyReportDTO> getReportsByProjectAndMonth(Long projectId, String month, int year) {
        return weeklyReportRepository.findByProjectAndMonthAndYear(projectId, month, year)
                .stream()
                .map(r -> WeeklyReportDTO.builder()
                        .id(r.getId())
                        .month(r.getMonth())
